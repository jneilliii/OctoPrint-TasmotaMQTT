...
class TasmotaMQTTPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_settings_defaults(self):
		return dict(
			arrRelays = [dict(index=1,topic="sonoff",relayN=1,warn=True,warnPrinting=True,gcode=False,currentstate="UNKNOWN",gcodeOnDelay=0,gcodeOffDelay=0,connect=False,connectOnDelay=15,disconnect=False,disconnectOffDelay=0)]
		)
